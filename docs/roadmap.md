...
- Add example generated Research Plan to `docs/examples/`.
...
- Add evaluation harness for search relevance and Research Plan quality.
...
- Research Plans are generated from abstracts and summaries, not full PDFs.
